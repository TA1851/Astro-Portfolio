    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20">
      ...
      >
        <div class="p-6">
          <div class="flex items-center mb-4">
            ...
            <h3 class="text-2xl font-bold text-white">VBA</h3>
          </div>
          <p class="text-gray-100">
            一番最初に触れた言語で、業務効率化のために習得しました。データクレンジングやグラフ作成の自動化ツールや
            ログデータの集計やログ解析を行うためのツールを作成していました。
          </p>
          <div class="mt-4 flex justify-end">
            <span class="px-3 py-1 bg-purple-600 text-white text-sm rounded-full">Office自動化</span>
          </div>
        </div>
      </div>
      ...
      >
        <div class="p-6">
          ...
          <p class="text-gray-100">
            VBAの次に習得した言語で、データ分析や機械学習のために習得しました。
            業務ではGUI自動化ツールを作成したり、データ収集やサイバーセキュリティプラットフォームの開発を行いました。
            ブログサービスの開発では、FastAPIを使用してシステムの構築を行いました。
          </p>
          <div class="mt-4 flex justify-end space-x-2">
            <span class="px-3 py-1 bg-blue-600 text-white text-sm rounded-full">FastAPI</span>
            <span class="px-3 py-1 bg-green-600 text-white text-sm rounded-full">自動化</span>
          </div>
        </div>
      </div>
      ...
      >
        <div class="p-6">
          <div class="flex items-center mb-4">
            <img src="data:image/svg+xml;base64," class="w-12 h-12 mr-4">
            <h3 class="text-2xl font-bold text-white">JS & TS</h3>
          </div>
          <p class="text-gray-100">
            現在、学習中の言語で、このサイトはVue3,AOSで作成しました。
            現在はReactを学習中で、ブログサービスの開発ではReact、Nextjsを使用して作成しました。
          </p>
          <div class="mt-4 flex justify-end space-x-2">
            <span class="px-3 py-1 bg-teal-600 text-white text-sm rounded-full">Vue</span>
            <span class="px-3 py-1 bg-blue-500 text-white text-sm rounded-full">React</span>
            <span class="px-3 py-1 bg-gray-600 text-white text-sm rounded-full">NextJS</span>
          </div>
        </div>
      </div>
    </div>
